...
The counting function was re-implemented from the definition in Lean~4
(mathlib-free, computable), and value certificates such as
$a_{3,2}(2)=8$, $a_{3,2}(3)=44$, $a_{3,3}(3)=342$, $a_{2,4}(3)=432$ are
proved by \texttt{native\_decide}, checking the Lean definition against
the OEIS data.  Formalizing Theorem~\ref{thm:main} itself, so that the
entire proof of each conjecture is machine-checked end to end, is in
