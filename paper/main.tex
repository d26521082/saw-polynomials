...
(OEIS)---a $k$-step walk is a sequence of $k$ distinct
cells in which consecutive cells are adjacent, and each direction is
counted separately.  We prove that
...
e.g.\ the 2023 proof notes of Corneth in entry A186864 (king's tours) and
of Howroyd in entry A186851 (knight's tours), the latter by a
bounding-box argument in the same spirit as ours.
...
of $k$ \emph{distinct} cells $c_1,\dots,c_k$ with $c_i$ adjacent to
$c_{i+1}$ (thus traversing $k-1$ edges), and a walk and its reversal are counted
